...
| Extension springs (v0.24) | 2× stainless extension spring, ~5–8 N, ≥40 mm working extension | 2 | The clamp force. They live INSIDE the outer shroud: hook one end to the bridge's fixed anchor and the other to the moving inner shroud's hook. Force is the feel — coupon-tune before committing. |
