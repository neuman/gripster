...
| TPU grippers (v0.24) | 2× soft **TPU 95A** edge-grip + capture lip (`gripper_left/right`), print with the keymats | 2 | The phone's mechanical retention: compliant grip on the cased short edge + a deep lip that captures the screen edge. Lip depth + clamp force are the **face-down-capture** tune (usable screen-down). |
| Extension springs (v0.24) | 2× stainless extension spring, ~5–8 N, ≥40 mm working extension | 2 | The clamp force, enclosed in the tray cavity, spanning grip-to-grip. Force is the feel — coupon-tune. |
| Battery power cable (v0.24) | 2-wire, ~2 mm OD, ≥240 mm, JST-PH to the 403040 pigtail | 1 | Carries the left-grip battery to J3 on the right board — runs ENCLOSED through the tray beside the FFC, with its own service loop. |
